            ...
            if (result == DialogResult.Yes) {
                ...
                while (true)
                {
                    if (sent_infinite == false)
                    {
                        if (!sent_infinite)
                        {
                            if (ts3.StartLayer4(Host, Method, Port, Time) == true)
                            {
                        ...
                        if (ts3.StartLayer4(Host, Method, Port, Time) != true || sent_infinite)
                        {
                            Other.Menus.showMessage("Error while sending attack. Breaking out of loop.", ConsoleColor.Red);
                            break;
                        }
